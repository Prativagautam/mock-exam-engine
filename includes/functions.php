...
if ( ! function_exists( 'mock_exam_engine_default_options' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function mock_exam_engine_default_options() {
		$default_theme_options = array(
			'setting1'  => esc_html__( 'Default Setting 1', 'mock-exam-engine' ),
			'setting2'  => esc_html__( 'Default Setting 2', 'mock-exam-engine' ),
			'setting3'  => false,
			'setting4'  => true,
			'setting5'  => 'option-1',
			'deleteAll' => false,
		...
		return apply_filters( 'mock_exam_engine_default_options', $default_theme_options );
	}
endif;

if ( ! function_exists( 'mock_exam_engine_get_options' ) ) :
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function mock_exam_engine_get_options( $key = '' ) {
		$options = get_option( MOCK_EXAM_ENGINE_OPTION_NAME );

		$default_options = mock_exam_engine_default_options();
...
if ( ! function_exists( 'mock_exam_engine_update_options' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function mock_exam_engine_update_options( $key_or_data, $val = '' ) {
		if ( is_string( $key_or_data ) ) {
			$options                 = mock_exam_engine_get_options();
			$options[ $key_or_data ] = $val;
		} else {
			$options = $key_or_data;
		}
		update_option( MOCK_EXAM_ENGINE_OPTION_NAME, $options );
	}
endif;


if ( ! function_exists( 'mock_exam_engine_file_system' ) ) {
	/**
	 *
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function mock_exam_engine_file_system() {
...
if ( ! function_exists( 'mock_exam_engine_parse_changelog' ) ) {
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function mock_exam_engine_parse_changelog() {

		$wp_filesystem = mock_exam_engine_file_system();

		$changelog_file = apply_filters( 'mock_exam_engine_changelog_file', MOCK_EXAM_ENGINE_PATH . 'readme.txt' );
...
if ( ! function_exists( 'mock_exam_engine_get_white_label' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function mock_exam_engine_get_white_label( $key = '' ) {
		$plugin_name = apply_filters(
			'mock_exam_engine_white_label_plugin_name',
			esc_html__( 'WP React Plugin Boilerplate', 'mock-exam-engine' )
		);

		$options = apply_filters(
			'mock_exam_engine_white_label',
			array(
				'admin_menu_page' => array(
					'page_title' => esc_html__( 'ReactJs Settings Page', 'mock-exam-engine' ),
					'menu_title' => esc_html__( 'ReactJs Settings', 'mock-exam-engine' ),
					'menu_slug'  => MOCK_EXAM_ENGINE_PLUGIN_NAME,
					'icon_url'   => MOCK_EXAM_ENGINE_URL . 'assets/img/logo-20-20.png',
					'position'   => null,
				),
				'dashboard'       => array(
					'logo'   => MOCK_EXAM_ENGINE_URL . 'assets/img/logo.png',
					'notice' => sprintf(
				...
				'landingPage'     => array(
					'banner'        => array(
						...
						'buttons'    => array(
							array(
								...
								'text'    => esc_html__( 'Get started', 'mock-exam-engine' ),
								'url'     => 'https://github.com/codersantosh/mock-exam-engine',
								'variant' => 'primary',
							),
							array(
								...
								'text'    => esc_html__( 'Docmentation', 'mock-exam-engine' ),
								'url'     => 'https://github.com/codersantosh/mock-exam-engine',
							...
							array(
								...
								'text'    => esc_html__( 'Get support', 'mock-exam-engine' ),
								'url'     => 'https://github.com/codersantosh/mock-exam-engine',
								'variant' => 'secondary',

							),
						),
						'image'      => MOCK_EXAM_ENGINE_URL . 'assets/img/featured-image.png',
					...
					'identity'      => array(
						...
						'buttons' => array(
							array(
								'text'    => esc_html__( 'Visit site', 'mock-exam-engine' ),
								'url'     => 'https://github.com/codersantosh/mock-exam-engine',
								'variant' => 'primary',
							),
							array(
					...
					'contact'       => array(
						'title'  => esc_html__( 'Contact Information', 'mock-exam-engine' ),
						'info'   => array(
							array(
								...
								'title'   => esc_html__( 'Support', 'mock-exam-engine' ),
								'text'    => esc_html__( 'Get Support', 'mock-exam-engine' ),
								'url'     => 'https://github.com/codersantosh/mock-exam-engine',
								'variant' => 'link',
							),
							array(
								...
								'title'   => esc_html__( 'Email', 'mock-exam-engine' ),
								'text'    => esc_html__( 'codersantosh@gmail.com', 'mock-exam-engine' ),
							...
							array(
								...
								'title' => esc_html__( 'Location', 'mock-exam-engine' ),
								'text'  => esc_html__( 'Kathmandu, Nepal', 'mock-exam-engine' ),
							),
						),
						'social' => array(
							array(
					...
					'bannerColumns' => array(
						array(
							...
							'title' => esc_html__( 'Activate Plugin', 'mock-exam-engine' ),
						),
						array(
							...
							'title' => esc_html__( 'Login settings', 'mock-exam-engine' ),
						),
						array(
							...
							'title' => esc_html__( 'Dashboard settings', 'mock-exam-engine' ),
						),
					),
					'normalColumns' => array(
						array(
							...
							'title'      => esc_html__( 'Knowledge base', 'mock-exam-engine' ),
							'content'    => esc_html__(
								'The utilization of this plugin can be facilitated by perusing comprehensive and well-documented articles.',
								'mock-exam-engine'
							),
							'buttonText' => esc_html__( 'Visit knowledge base', 'mock-exam-engine' ),
							'buttonLink' => 'https://github.com/codersantosh/mock-exam-engine',

						),
						array(
							'icon'       => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/><path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6m0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5"/></svg>',
							'title'      => esc_html__( 'Community', 'mock-exam-engine' ),
							'content'    => sprintf(
							/* translators: %s is the plugin name */
								esc_html__(
							...
							'buttonText' => esc_html__( 'Visit community page', 'mock-exam-engine' ),
							'buttonLink' => 'https://github.com/codersantosh/mock-exam-engine',
						),
						array(
							...
							'title'      => esc_html__( '24x7 support', 'mock-exam-engine' ),
							'content'    => sprintf(
							/* translators: %s is the plugin name */
								esc_html__(
							...
							'buttonText' => esc_html__( 'Create a support thread', 'mock-exam-engine' ),
							'buttonLink' => 'https://github.com/codersantosh/mock-exam-engine',
						...
						array(
							...
							'title'      => esc_html__( 'Video guide', 'mock-exam-engine' ),
							'content'    => sprintf(
							/* translators: %s is the plugin name */
								esc_html__(
							...
							'buttonText' => esc_html__( 'View video guide', 'mock-exam-engine' ),
							'buttonLink' => 'https://github.com/codersantosh/mock-exam-engine',
					...
					'topicLinks'    => array(
						...
						'title'   => esc_html__( 'Quick links to settings', 'mock-exam-engine' ),
						'columns' => array(
							array(
								'icon'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/></svg>',
								'title'   => esc_html__( 'Settings 1', 'mock-exam-engine' ),
							...
							array(
								'icon'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/></svg>',
								'title'   => esc_html__( 'Advanced settings', 'mock-exam-engine' ),
					...
					'changelog'     => array(
						...
						'title'   => esc_html__( 'Changelog', 'mock-exam-engine' ),
						'content' => mock_exam_engine_parse_changelog(),
					),
				),
			)
		);
